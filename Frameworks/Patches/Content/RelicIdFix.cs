    ...
    public class RelicIdFix
    {
        ...
        public static class ManualAssignId
        {
            ...
            private static void assignNetId(Type type)
            {
                ...
                if (type.GetCustomAttribute<OldRelicsAncientPoolAttribute>(false) is { } ancientAttr)
                {
                    var r = (RelicModel)_contentById[ModelDb.GetId(type)];
                    if (r is IOldRelicModel or)
                    {
